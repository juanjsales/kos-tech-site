    ...
    <section id="tabela" className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 border-t border-slate-800/80">
      ...
      <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
        <span className="text-xs font-mono uppercase tracking-widest text-cyan-400 bg-cyan-950/60 border border-cyan-800/60 px-3.5 py-1.5 rounded-full inline-block">
          Investimento Sem Pegadinhas
        </span>
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white font-sans tracking-tight">
          Tabela de Engenharia & Preços
        </h2>
        <p className="text-slate-400 text-base md:text-lg">
          Arquiteturas de implantação em cotação de taxa única, 100% livres de custos fixos recorrentes ou mensalidades de servidor.
        </p>
      </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-slate-800 text-xs font-mono font-bold tracking-wider uppercase text-slate-300 bg-slate-900/80">
                <th className="p-6 w-2/5">Módulos de Arquitetura</th>
                <th className="p-6 text-center">
                  <span className="block text-slate-200 text-sm font-bold">📍 Local</span>
                ...
                <th className="p-6 text-center bg-blue-950/40 border-x border-cyan-500/30 relative">
                  ...
                  <span className="block text-white text-base font-extrabold mt-1">🪐 Ecossistema</span>
            ...
            <tbody className="text-sm divide-y divide-slate-800/80 text-slate-300">
              ...
              <tr className="hover:bg-slate-900/50 transition-colors">
                <td className="p-6 font-medium text-white">Engenharia Google Maps & SEO Local Auditado</td>
              ...
              <tr className="hover:bg-slate-900/50 transition-colors">
                <td className="p-6 font-medium text-white">Desenvolvimento Edge Static Serverless (Vercel / Next.js)</td>
                <td className="p-6 text-center text-slate-600"><X className="w-5 h-5 mx-auto" /></td>
                <td className="p-6 text-center text-cyan-400 font-bold text-lg"><Check className="w-5 h-5 mx-auto" /></td>
                <td className="p-6 text-center text-cyan-400 font-bold text-lg bg-blue-950/20"><Check className="w-5 h-5 mx-auto" /></td>
              </tr>
              ...
              <tr className="hover:bg-slate-900/50 transition-colors">
                <td className="p-6 font-medium text-white">Canais Inteligentes de Captura & WhatsApp Direct Bot</td>
                <td className="p-6 text-center text-slate-600"><X className="w-5 h-5 mx-auto" /></td>
                <td className="p-6 text-center text-cyan-400 font-bold text-lg"><Check className="w-5 h-5 mx-auto" /></td>
                <td className="p-6 text-center text-cyan-400 font-bold text-lg bg-blue-950/20"><Check className="w-5 h-5 mx-auto" /></td>
              </tr>
              ...
              <tr className="hover:bg-slate-900/50 transition-colors">
                <td className="p-6 font-medium text-white">Integração Webhooks / CRM / Mercado Pago / Stripe</td>
                <td className="p-6 text-center text-slate-600"><X className="w-5 h-5 mx-auto" /></td>
                <td className="p-6 text-center text-slate-600"><X className="w-5 h-5 mx-auto" /></td>
                <td className="p-6 text-center text-cyan-400 font-bold text-lg bg-blue-950/20"><Check className="w-5 h-5 mx-auto" /></td>
              </tr>
              ...
              <tr className="hover:bg-slate-900/50 transition-colors">
                <td className="p-6 font-medium text-white">Garantia Nativa & Suporte Pós-Lançamento (30 Dias)</td>
                <td className="p-6 text-center text-cyan-400 font-bold text-lg"><Check className="w-5 h-5 mx-auto" /></td>
                <td className="p-6 text-center text-cyan-400 font-bold text-lg"><Check className="w-5 h-5 mx-auto" /></td>
                <td className="p-6 text-center text-cyan-400 font-bold text-lg bg-blue-950/20"><Check className="w-5 h-5 mx-auto" /></td>
              </tr>
      ...
      <div className="mt-6 flex flex-wrap items-center justify-center gap-6 text-slate-400 text-xs font-mono">
        <span className="flex items-center gap-1.5"><ShieldCheck className="w-4 h-4 text-emerald-400" /> Pagamento Único Sem Custos Recorrentes</span>
        <span className="flex items-center gap-1.5"><ShieldCheck className="w-4 h-4 text-cyan-400" /> Nota Fiscal PJ Emita Disponível</span>
        <span className="flex items-center gap-1.5"><ShieldCheck className="w-4 h-4 text-purple-400" /> Atendimento Direto pelo Engenheiro</span>
      </div>
